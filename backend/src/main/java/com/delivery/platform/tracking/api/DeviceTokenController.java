...
@RestController @RequestMapping({"/api/v1/device-tokens","/api/v1/couriers/me/device-tokens"})
public class DeviceTokenController {
  ...
  @PostMapping @ResponseStatus(HttpStatus.NO_CONTENT) @PreAuthorize("isAuthenticated()")
  ...
  @DeleteMapping @ResponseStatus(HttpStatus.NO_CONTENT) @PreAuthorize("isAuthenticated()")
