...
class MerchantCourierAssignmentServiceTest {
 ...
 @Test void reconciliationPublishesToTheSpecificMerchantTopic(){UUID merchant=UUID.randomUUID();assertEquals("merchant/"+merchant,MerchantCourierAssignmentService.merchantTopic(merchant));}
}
